package com.example.mobilityindia.livelihood.adapterlivelihood;
...
import com.example.mobilityindia.livelihood.LivelihoodActivity;
import com.google.android.material.button.MaterialButton;

import java.util.ArrayList;

public class AdapterLivelihood extends RecyclerView.Adapter<AdapterLivelihood.ViewHolder> {
    private final Activity context;
    private ArrayList<String> data = new ArrayList<>();

    public AdapterLivelihood(ArrayList<String> data, Activity context) {
        this.data = data;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, LivelihoodActivity.class);
