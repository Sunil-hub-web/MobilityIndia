...
public interface ApiRequest
{
    ...
    Call<ChangepinresponceResponse> changemypin(@Header("Authorization") String token,@FieldMap Map<String,Object> user);
    ...
    @FormUrlEncoded
    @POST("api/addSocial")
    Call<SocialResponse> addSocialData(@Header("Authorization") String token, @FieldMap Map<String,Object> user);

    @FormUrlEncoded
    @POST("api/addHealth")
    Call<HealthResponse> addHealthData(@Header("Authorization") String token, @FieldMap Map<String,Object> user);
