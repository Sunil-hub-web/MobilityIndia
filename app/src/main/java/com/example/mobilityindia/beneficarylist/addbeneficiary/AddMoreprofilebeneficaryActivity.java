...
public class AddMoreprofilebeneficaryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        binding.buttonnext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                String familymemberadultm = binding.familymemberadultm.getText().toString();

//                if(familymemberadultm.isEmpty()){
//
//                }else {
//                    int familymemberadultmint = Integer.parseInt(familymemberadultm);
//                    if(familymemberadultmint<15){
//                    }else{
//                        Toast.makeText(AddMoreprofilebeneficaryActivity.this, "Family Member-Adults(M) Shuold be less then 15", Toast.LENGTH_SHORT).show();
