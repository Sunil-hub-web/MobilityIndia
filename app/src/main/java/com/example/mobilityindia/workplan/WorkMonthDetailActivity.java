...
*/
                ...
                if (statues.equals("1")) {
                    ...
                    if(Utils.isNetworkAvailable(WorkMonthDetailActivity.this)){
                        ...
                        callSaveApi(tempUserId,tempId,monYr,noOfVillageVisit,noOfGovtVisit,meetingInternal,meetingExternal,
                                noOfTrainingAttended,noOfTrainingFacilated,noOfOtherEvent);
                        ...
                        Toast.makeText(WorkMonthDetailActivity.this, "Data Store Locally", Toast.LENGTH_SHORT).show();
  ...
  /*  //-----------
    ...
    public void callSaveApi(String user_id,String id,String month_year,String no_village_visit,String no_govt_visit,String meeting_attend_internal,
                            String meeting_attend_external,String no_of_training_attend,String no_of_training_facilited,String other_events){
        ...
        String url = "http://mimis.zbapps.in/api/activityreport/update_own";
