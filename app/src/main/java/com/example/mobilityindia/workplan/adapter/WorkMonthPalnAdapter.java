...
public class WorkMonthPalnAdapter extends RecyclerView.Adapter<WorkMonthPalnAdapter.ViewHolder> {
    ...
    TextView first_half, second_half_txt;
    LocalRepo localRepo;
    ...
    private void OpenDialouge(String id, String userId, String dateattend) {
        ...
        TextView Firsthalf = dialog.findViewById(R.id.Firsthalf);
        TextView Secondhalf = dialog.findViewById(R.id.Secondhalf);

       // saveBtn.setFocusable(false);

        //saveBtn.setVisibility(View.VISIBLE);

        String[] genderName = {"Attendance", "Present", "HDL", "CL", "SL", "AL", "Holiday"};

        String[] itemNames = context.getResources().getStringArray(R.array.gender);
        ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(context.getApplicationContext(), android.R.layout.simple_spinner_dropdown_item, itemNames);
        adapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        attandance_edt.setAdapter(adapter2);

        String attandance = attandance_edt.getText().toString();
       ...
       attandance_edt.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (first_half.getText().toString().equalsIgnoreCase("")) {
                    ...
                    if (arrayList.contains(id)) {
                        ...
                        if (attandance.equalsIgnoreCase("Present")) {
                            ...
                            attedanceData.setDateAttendance(dateattend);
                            attedanceData.setAttendance(attandance);
                            attedanceData.setFirstHalf(firstHalf);
                            attedanceData.setSecondHalf(secondHalf);
                            attedanceData.setStatus(monthyear);

                            //localRepo.deleteActivityRep(attedanceData);
                            localRepo.insertActivityRep(attedanceData);
                            ...
                            attedanceData.setDateAttendance(dateattend);
                            attedanceData.setAttendance(attandance);
                            attedanceData.setFirstHalf("null");
                            attedanceData.setSecondHalf("null");
                            attedanceData.setStatus(monthyear);
        ...
        attandance_edt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(statues.equalsIgnoreCase("1")){}else if(statues.equalsIgnoreCase("2")){}else{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (statues.equalsIgnoreCase("1")) {
                ...
                OpenDialouge(id, userId, dateAttendance);
