...
public class MonthWorkPlanActivity extends AppCompatActivity {
        ...
        binding.submitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.isNetworkAvailable(MonthWorkPlanActivity.this)) {
                    ...
                    Toast.makeText(MonthWorkPlanActivity.this, "Internet Is Not Avilable Data Store  locally", Toast.LENGTH_SHORT).show();
                }
    ...
    public void retriveAttendDetails(String userID, String monthyear) {
        ...
        String url = "http://mimis.zbapps.in/api/activityreport/attendance";
    ...
    public void updateAttendance(JSONArray jsonArray) {
        ...
        String url = "http://mimis.zbapps.in/api/activityreport/update_attendance";
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (status.equals("true")) {
                        ...
                        Toast.makeText(MonthWorkPlanActivity.this, "Data Svae Successfully", Toast.LENGTH_SHORT).show();
    ...
    public void SubmitAttendance(JSONArray jsonArray) {
        ...
        String url = "http://mimis.zbapps.in/api/activityreport/group_update_activity_report";
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (status.equals("true")) {
                        ...
                        Intent intent = new Intent(MonthWorkPlanActivity.this,WorkPlanActivity.class);
